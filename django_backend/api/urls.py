...
from users.views_avatar import serve_avatar
...
urlpatterns = [
    ...
    path('internal/frontend-logs/', views.frontend_logs, name='frontend_logs'),
    ...
    # User avatars
    path('users/avatar/<uuid:user_uuid>/', serve_avatar, name='serve_avatar'),
